...
data_bulk(1,8) = DATA_CREP.Cr_bulk(i) ; % Cr (ppm)
...
data_bulk(1,7) = DATA_CREP.Co_bulk(i) ; % Co (ppm)
...
site.shield = DATA_CREP.Shield(i);
site.erosion = DATA_CREP.Eros(i); % erosion rate (cm/an)
